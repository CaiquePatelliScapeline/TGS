            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4">
                        <h1 class="mt-4">Cadastrar Paciente</h1>
	                        ...
	                        <div class="row align-items-center">
								...
								<div class="mb-3 col-6">
							  	...
							  	<div class="mb-3 col-3">
							    	...
							    	<input type="text" class="form-control" id="rg" aria-describedby="rg">	
							  	</div>							  	
							  	<div class="mb-3 col-2">
							    	<label for="BirthDate" class="form-label">Data de Nascimento</label>							    	
							    	<input type="date" class="form-control" id="birthDate" aria-describedby="birthDate">							    	
							  	</div>
							  	<div class="mb-3 col-2">
							    	<label for="Height" class="form-label">Altura</label>
							    	<input type="text" class="form-control" id="height" aria-describedby="height">	
							  	</div>
							  	<div class="mb-3 col-2">
				  				...
				  				<div class="mb-3 col-6">
    								...
    								<input type="text" class="form-control" id="neighborhood" aria-describedby="neighborhood">
				  				</div>
				  				...
				  				<div class="mb-3 col-1">
    								...
    								<input type="text" class="form-control" id="district" aria-describedby="district">
				  				</div>				  				
				  				<div class="mb-3 col-6">
    								<label for="Compliment" class="form-label">Complemento</label>
    								<input type="text" class="form-control" id="compliment" aria-describedby="compliment">
				  				</div>				  				
