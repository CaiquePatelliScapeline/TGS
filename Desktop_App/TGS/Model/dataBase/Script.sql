...
SELECT S.DATE_SCHEDULE, S.TIME_SCHEDULE, D.NAME_DENTIST, D.LAST_NAME AS LAST_NAME_DENTIST, S.STATUS_SCHEDULE, P.NAME_PATIENT, P.LAST_NAME AS LAST_NAME_PATIENT, P.NICKNAME, PR.PROCEDURE_TITLE FROM TB_SCHEDULING AS S, TB_DENTISTS AS D, TB_CONSULTS AS C, TB_PATIENTS AS P, TB_PROCEDURES AS PR WHERE S.CRO_DENTIST = D.CRO_DENTIST AND C.CPF_PATIENT = P.CPF_PATIENT AND C.ID_PROCEDURE = PR.ID_PROCEDURE ORDER BY S.ID_SCHEDULE;