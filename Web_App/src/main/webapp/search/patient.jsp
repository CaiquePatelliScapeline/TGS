                    ...
                    <div class="container-fluid px-4">
                        ...
                        <div class="row" style="margin-bottom: 12px">
                            <div class="btn-toolbar btn-lg flex-row-reverse" role="toolbar" aria-label="Toolbar with button groups">																			    							   							    
							    <a href="../create/patient.jsp" class="btn btn-primary btn-lg" role="button" aria-pressed="true"><img src="../assets/icons/add.svg" height="30px" class="mr-8"/>Add Dentista</a>
							</div>
                        </div>
                        
                        <% 
                        	Table table = new Table("Pacientes ativos");
                        	out.print(table);
                        %>
                    </div>
                </main>                
