...
UPDATE TB_CONSULTS SET STATUS_SCHEDULE = 1, CPF_EMPLOYEE = '803.047.456-75', CPF_PATIENT = '123.456.789-11', ID_PROCEDURE = 1 WHERE TB_CONSULTS.ID_CONSULT = 1;
...
WHERE C.CRO_DENTIST = D.CRO_DENTIST AND C.CPF_PATIENT = P.CPF_PATIENT AND C.ID_PROCEDURE = PR.ID_PROCEDURE 
