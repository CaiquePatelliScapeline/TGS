...
<html lang="pt-br">
    <head>
        ...
        <meta name="author" content="Murilo Gustavo da Costa Schali"/>
            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4">
                        <h1 class="mt-4">Dentistas</h1>
                        <ol class="breadcrumb mb-4">
                            <li class="breadcrumb-item active">Dashboard</li>
                        </ol>
                        <div class="row" style="margin-bottom: 12px">
                            <div class="btn-toolbar btn-lg flex-row-reverse" role="toolbar" aria-label="Toolbar with button groups">																			    							   							    
							    <a href="../create/dentist.jsp" class="btn btn-primary btn-lg" role="button" aria-pressed="true"><img src="../assets/icons/add.svg" height="30px" class="mr-8"/>Add Dentista</a>
							</div>
                        </div>
                        
                        <% 
                        	Table table = new Table("Dentistas ativos");
                        	out.print(table);
                        %>
                    </div>
                </main>                
