...
namespace Unit_Test {
    ...
    public class RegisterCases {
        public static List<TestCaseData> Schedulings {
            get {
                return new List<TestCaseData>() {
                    ...
                    new TestCaseData("12.623", "111/09/0000", "08:00").Returns(false).SetCategory("Agendamento Inválido"),
                    ...
                    new TestCaseData("12.623", "01/90/2021", "998:00").Returns(false).SetCategory("Agendamento Inválido"),
                    new TestCaseData("12.623", "01/90/2021", "26:00").Returns(false).SetCategory("Agendamento Inválido"),
                    new TestCaseData("12.623", "01/90/2021", "08:80").Returns(false).SetCategory("Agendamento Inválido"),
                    new TestCaseData("12.623", "01/90/2021", "08:888").Returns(false).SetCategory("Agendamento Inválido")
                };
            }
        }
        ...
        public static List<TestCaseData> Consults {
            get {
                return new List<TestCaseData>() {
                    new TestCaseData("123.123.123-12", 1, 4).Returns(true).SetCategory("Agendamento Válido"),
                    new TestCaseData("", 1, 4).Returns(false).SetCategory("Agendamento Inválido"),
                    new TestCaseData("12312312312", 1, 4).Returns(false).SetCategory("Agendamento Inválido"),
                    new TestCaseData("123.123.123.12", 1, 4).Returns(false).SetCategory("Agendamento Inválido"),
                    new TestCaseData("123.123.123-1", 1, 4).Returns(false).SetCategory("Agendamento Inválido"),
                    new TestCaseData("123.123.123-123", 1, 4).Returns(false).SetCategory("Agendamento Inválido"),
                    new TestCaseData("123.123.123-AA", 1, 4).Returns(false).SetCategory("Agendamento Inválido"),
                    new TestCaseData("123.123.123-**", 1, 4).Returns(false).SetCategory("Agendamento Inválido"),
                    new TestCaseData("123.123.123-12", null, 4).Returns(false).SetCategory("Agendamento Inválido"),
                    new TestCaseData("123.123.123-12", "AA", 4).Returns(false).SetCategory("Agendamento Inválido"),
                    new TestCaseData("123.123.123-12", "*$%", 4).Returns(false).SetCategory("Agendamento Inválido"),
                    new TestCaseData("123.123.123-12", 1, null).Returns(false).SetCategory("Agendamento Inválido"),
                    new TestCaseData("123.123.123-12", 1, "AA").Returns(false).SetCategory("Agendamento Inválido"),
                    new TestCaseData("123.123.123-12", 1, "(*@").Returns(false).SetCategory("Agendamento Inválido")
                };
            }
        }
        ...
        public static List<TestCaseData> Patients {
            get {
                return new List<TestCaseData>() {
                    ...
                    new TestCaseData("123.123.123-12", "12.123.123-4", "Ronaldo", "Junqueira", "123", "11/08/1980", "1,70", "80,5", "(19)1234-1234", "(19)91234-1234", "Rua Um", "Alameda das Flores", "Itu", "SP", "12.123-123", "Casa 2", "105").Returns(false).SetCategory("Paciente Inválido"),
                    new TestCaseData("123.123.123-12", "12.123.123-4", "Ronaldo", "Junqueira", "***", "11/08/1980", "1,70", "80,5", "(19)1234-1234", "(19)91234-1234", "Rua Um", "Alameda das Flores", "Itu", "SP", "12.123-123", "Casa 2", "105").Returns(false).SetCategory("Paciente Inválido"),
                    new TestCaseData("123.123.123-12", "12.123.123-4", "Ronaldo", "Junqueira", "", "1,70", "80,5", "(19)1234-1234", "(19)91234-1234", "Rua Um", "Alameda das Flores", "Itu", "SP", "12.123-123", "Casa 2", "105").Returns(true).SetCategory("Paciente Válido"),
                    new TestCaseData("123.123.123-12", "12.123.123-4", "Ronaldo", "Junqueira", "Ana", "AA/08/1980", "1,70", "80,5", "(19)1234-1234", "(19)91234-1234", "Rua Um", "Alameda das Flores", "Itu", "SP", "12.123-123", "Casa 2", "105").Returns(false).SetCategory("Paciente Inválido"),
                    new TestCaseData("123.123.123-12", "12.123.123-4", "Ronaldo", "Junqueira", "Ana", "11/AA/1980", "1,70", "80,5", "(19)1234-1234", "(19)91234-1234", "Rua Um", "Alameda das Flores", "Itu", "SP", "12.123-123", "Casa 2", "105").Returns(false).SetCategory("Paciente Inválido"),
                    new TestCaseData("123.123.123-12", "12.123.123-4", "Ronaldo", "Junqueira", "Ana", "11/08/AAAA", "1,70", "80,5", "(19)1234-1234", "(19)91234-1234", "Rua Um", "Alameda das Flores", "Itu", "SP", "12.123-123", "Casa 2", "105").Returns(false).SetCategory("Paciente Inválido"),
                    new TestCaseData("123.123.123-12", "12.123.123-4", "Ronaldo", "Junqueira", "Ana", "11/08/1980", "", "80,5", "(19)1234-1234", "(19)91234-1234", "Rua Um", "Alameda das Flores", "Itu", "SP", "12.123-123", "Casa 2", "105").Returns(true).SetCategory("Paciente Válido"),                                                                                               
                    new TestCaseData("123.123.123-12", "12.123.123-4", "Ronaldo", "Junqueira", "Ana", "11/08/1980", "A,70", "80,5", "(19)1234-1234", "(19)91234-1234", "Rua Um", "Alameda das Flores", "Itu", "SP", "12.123-123", "Casa 2", "105").Returns(false).SetCategory("Paciente Inválido"),                   
                    new TestCaseData("123.123.123-12", "12.123.123-4", "Ronaldo", "Junqueira", "Ana", "11/08/1980", "1.70", "", "(19)1234-1234", "(19)91234-1234", "Rua Um", "Alameda das Flores", "Itu", "SP", "12.123-123", "Casa 2", "105").Returns(true).SetCategory("Paciente Válido"),                                                                                              
                    new TestCaseData("123.123.123-12", "12.123.123-4", "Ronaldo", "Junqueira", "Ana", "11/08/1980", "1.70", "AA,5", "(19)1234-1234", "(19)91234-1234", "Rua Um", "Alameda das Flores", "Itu", "SP", "12.123-123", "Casa 2", "105").Returns(false).SetCategory("Paciente Inválido"),
                    new TestCaseData("123.123.123-12", "12.123.123-4", "Ronaldo", "Junqueira", "Ana", "11/08/1980", "1.70", "80,A", "(19)1234-1234", "(19)91234-1234", "Rua Um", "Alameda das Flores", "Itu", "SP", "12.123-123", "Casa 2", "105").Returns(false).SetCategory("Paciente Inválido"),
                    new TestCaseData("123.123.123-12", "12.123.123-4", "Ronaldo", "Junqueira", "Ana", "11/08/1980", "1.70", "80,5", "", "(19)91234-1234", "Rua Um", "Alameda das Flores", "Itu", "SP", "12.123-123", "Casa 2", "105").Returns(true).SetCategory("Paciente Válido"),
                    new TestCaseData("123.123.123-12", "12.123.123-4", "Ronaldo", "Junqueira", "Ana", "11/08/1980", "1.70", "80,5", "(AA)1234-1234", "(19)91234-1234", "Rua Um", "Alameda das Flores", "Itu", "SP", "12.123-123", "Casa 2", "105").Returns(false).SetCategory("Paciente Inválido"),
                    new TestCaseData("123.123.123-12", "12.123.123-4", "Ronaldo", "Junqueira", "Ana", "11/08/1980", "1.70", "80,5", "(19)AAAA-1234", "(19)91234-1234", "Rua Um", "Alameda das Flores", "Itu", "SP", "12.123-123", "Casa 2", "105").Returns(false).SetCategory("Paciente Inválido"),
                    new TestCaseData("123.123.123-12", "12.123.123-4", "Ronaldo", "Junqueira", "Ana", "11/08/1980", "1.70", "80,5", "(19)1234-AAAA", "(19)91234-1234", "Rua Um", "Alameda das Flores", "Itu", "SP", "12.123-123", "Casa 2", "105").Returns(false).SetCategory("Paciente Inválido"),
                    new TestCaseData("123.123.123-12", "12.123.123-4", "Ronaldo", "Junqueira", "Ana", "11/08/1980", "1.70", "80,5", "(19)1234-1234", "(19)91234-1234", "", "Alameda das Flores", "Itu", "SP", "12.123-123", "Casa 2", "105").Returns(false).SetCategory("Paciente Inválido"),
                    new TestCaseData("123.123.123-12", "12.123.123-4", "Ronaldo", "Junqueira", "Ana", "11/08/1980", "1.70", "80,5", "(19)1234-1234", "(19)91234-1234", "**", "Alameda das Flores", "Itu", "SP", "12.123-123", "Casa 2", "105").Returns(false).SetCategory("Paciente Inválido"),
                    new TestCaseData("123.123.123-12", "12.123.123-4", "Ronaldo", "Junqueira", "Ana", "11/08/1980", "1.70", "80,5", "(19)1234-1234", "(19)91234-1234", "Rua Um", "", "Itu", "SP", "12.123-123", "Casa 2", "105").Returns(false).SetCategory("Paciente Inválido"),
                    new TestCaseData("123.123.123-12", "12.123.123-4", "Ronaldo", "Junqueira", "Ana", "11/08/1980", "1.70", "80,5", "(19)1234-1234", "(19)91234-1234", "Rua Um", "**", "Itu", "SP", "12.123-123", "Casa 2", "105").Returns(false).SetCategory("Paciente Inválido"),
                    new TestCaseData("123.123.123-12", "12.123.123-4", "Ronaldo", "Junqueira", "Ana", "11/08/1980", "1.70", "80,5", "(19)1234-1234", "(19)91234-1234", "Rua Um", "Alameda das Flores", "", "SP", "12.123-123", "Casa 2", "105").Returns(false).SetCategory("Paciente Inválido"),
                    new TestCaseData("123.123.123-12", "12.123.123-4", "Ronaldo", "Junqueira", "Ana", "11/08/1980", "1.70", "80,5", "(19)1234-1234", "(19)91234-1234", "Rua Um", "Alameda das Flores", "**", "SP", "12.123-123", "Casa 2", "105").Returns(false).SetCategory("Paciente Inválido"),
                    new TestCaseData("123.123.123-12", "12.123.123-4", "Ronaldo", "Junqueira", "Ana", "11/08/1980", "1.70", "80,5", "(19)1234-1234", "(19)91234-1234", "Rua Um", "Alameda das Flores", "Itu", "", "12.123-123", "Casa 2", "105").Returns(false).SetCategory("Paciente Inválido"),
                    new TestCaseData("123.123.123-12", "12.123.123-4", "Ronaldo", "Junqueira", "Ana", "11/08/1980", "1.70", "80,5", "(19)1234-1234", "(19)91234-1234", "Rua Um", "Alameda das Flores", "Itu", "**", "12.123-123", "Casa 2", "105").Returns(false).SetCategory("Paciente Inválido"),
                    new TestCaseData("123.123.123-12", "12.123.123-4", "Ronaldo", "Junqueira", "Ana", "11/08/1980", "1.70", "80,5", "(19)1234-1234", "(19)91234-1234", "Rua Um", "Alameda das Flores", "Itu", "SP", "", "Casa 2", "105").Returns(false).SetCategory("Paciente Inválido"),
                    new TestCaseData("123.123.123-12", "12.123.123-4", "Ronaldo", "Junqueira", "Ana", "11/08/1980", "1.70", "80,5", "(19)1234-1234", "(19)91234-1234", "Rua Um", "Alameda das Flores", "Itu", "SP", "AA.123-123", "Casa 2", "105").Returns(false).SetCategory("Paciente Inválido"),
                    new TestCaseData("123.123.123-12", "12.123.123-4", "Ronaldo", "Junqueira", "Ana", "11/08/1980", "1.70", "80,5", "(19)1234-1234", "(19)91234-1234", "Rua Um", "Alameda das Flores", "Itu", "SP", "12.123-AAA", "Casa 2", "105").Returns(false).SetCategory("Paciente Inválido"),
                    new TestCaseData("123.123.123-12", "12.123.123-4", "Ronaldo", "Junqueira", "Ana", "11/08/1980", "1.70", "80,5", "(19)1234-1234", "(19)91234-1234", "Rua Um", "Alameda das Flores", "Itu", "SP", "12.123-", "Casa 2", "105").Returns(false).SetCategory("Paciente Inválido"),
                    new TestCaseData("123.123.123-12", "12.123.123-4", "Ronaldo", "Junqueira", "Ana", "11/08/1980", "1.70", "80,5", "(19)1234-1234", "(19)91234-1234", "Rua Um", "Alameda das Flores", "Itu", "SP", "12.123-**", "Casa 2", "105").Returns(false).SetCategory("Paciente Inválido"),
                    new TestCaseData("123.123.123-12", "12.123.123-4", "Ronaldo", "Junqueira", "Ana", "11/08/1980", "1.70", "80,5", "(19)1234-1234", "(19)91234-1234", "Rua Um", "Alameda das Flores", "Itu", "SP", "12.123-**", "", "105").Returns(true).SetCategory("Paciente Válido"),
                    new TestCaseData("123.123.123-12", "12.123.123-4", "Ronaldo", "Junqueira", "Ana", "11/08/1980", "1.70", "80,5", "(19)1234-1234", "(19)91234-1234", "Rua Um", "Alameda das Flores", "Itu", "SP", "12.123-123", "**", "105").Returns(false).SetCategory("Paciente Inválido"),
                    new TestCaseData("123.123.123-12", "12.123.123-4", "Ronaldo", "Junqueira", "Ana", "11/08/1980", "1.70", "80,5", "(19)1234-1234", "(19)91234-1234", "Rua Um", "Alameda das Flores", "Itu", "SP", "12.123-123", "Casa 2 ", "").Returns(false).SetCategory("Paciente Inválido"),
                    new TestCaseData("123.123.123-12", "12.123.123-4", "Ronaldo", "Junqueira", "Ana", "11/08/1980", "1.70", "80,5", "(19)1234-1234", "(19)91234-1234", "Rua Um", "Alameda das Flores", "Itu", "SP", "12.123-123", "Casa 2 ", "**").Returns(false).SetCategory("Paciente Inválido")
                };                                                                                                                  
            }
        }
